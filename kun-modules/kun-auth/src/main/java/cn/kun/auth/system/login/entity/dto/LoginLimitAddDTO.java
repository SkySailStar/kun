...
@Schema(description = "用户登陆限制信息添加-传入值")
@Data
public class LoginLimitAddDTO implements Serializable {
    @Serial
    ...
    @Schema(description = "限制登录开始时间")
    @NotNull(message = "限制登录开始时间不能为空")
    private LocalDateTime startDate;

    @Schema(description = "限制登陆结束时间")
    @NotNull(message = "限制登陆结束时间不能为空")
