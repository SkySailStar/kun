package cn.kun.auth.system.login.entity.po;
...
@Getter
@Setter
@TableName("login_user_info_outer")
@Schema(name = "LoginUserInfoOuter", description = "外部用户登录信息表")
public class LoginUserInfoOuter extends BaseEntity {
