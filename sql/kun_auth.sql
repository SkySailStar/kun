...
create table sys_dept (
                          ...
                          primary key (dept_id)
) engine=innodb =200 comment = '部门表';

-- ----------------------------
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '天航星科技',   0, '琨', '15888888888', '123456@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '重庆总公司', 1, '琨', '15888888888', '123456@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '琨', '15888888888', '123456@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '管理员', '00', '123456@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
...
create table sys_role (
                          ...
                          remark               varchar(500)    default null               comment '备注',
                          primary key (role_id)
) engine=innodb =100 comment = '角色信息表';
...
create table sys_menu (
                          ...
                          primary key (menu_id)
) engine=innodb =2000 comment = '菜单权限表';
