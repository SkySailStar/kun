...
import cn.kun.base.core.global.util.json.JsonUtils;
...
public class RedisUtils {
    ...
    public void setDefaultDatabase(Integer defaultDatabase) {
        RedisUtils.defaultDatabase = defaultDatabase;
    }
    ...
    public static <T> T get(int database, String key, Class<T> tClass) {
        ...
        return JsonUtils.toEntity(result, tClass);
    }
    ...
    public static <T> List<T> getList(int database, String key, long start, long end, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toList(jedis.lrange(key, start, end), tClass);
        } catch (Exception e) {
            log.warn("lrange {} {} {}", key, start, end, e);
        } finally {
            returnResource(jedis);
    ...
    public static <T> Set<T> getSet(int database, String key, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toSet(jedis.smembers(key), tClass);
        } catch (Exception e) {
            log.warn("smembers {}", key, e);
        } finally {
            returnResource(jedis);
    ...
    public static <T> T randomSet(int database, String key, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toEntity(jedis.srandmember(key), tClass);
        } catch (Exception e) {
            log.warn("srandmember {}", key, e);
        } finally {
            returnResource(jedis);
    ...
    public static void setHash(String key, String field, Object value) {
        ...
        setHash(defaultDatabase, key, field, value, 0);
    }
    ...
    public static void setHash(String key, String field, Object value, long time) {
        ...
        setHash(defaultDatabase, key, field, value, time);
    }
     ...
     * @param value 值
     */
    public static void setHash(int database, String key, String field, Object value, long time) {
    ...
    public static <T> Map<String, T> getHash(int database, String key, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toMap(jedis.hgetAll(key), tClass);
        } catch (Exception e) {
            log.warn("hgetAll {}", key, e);
        } finally {
            returnResource(jedis);
    ...
    public static <T> List<T> getHashList(int database, String key, String field, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toList(jedis.hget(key, field), tClass);
        } catch (Exception e) {
            log.warn("hget {} {}", key, field, e);
        } finally {
            returnResource(jedis);
    ...
    public static <T> List<T> getHashList(int database, String key, List<String> field, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toList(jedis.hmget(key, field.toArray(new String[0])), tClass);
        } catch (Exception e) {
            log.warn("hget {} {}", key, field, e);
        } finally {
            returnResource(jedis);
    ...
    public static <T> Set<T> getHashSet(int database, String key, String field, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toSet(jedis.hget(key, field), tClass);
        } catch (Exception e) {
            log.warn("hget {} {}", key, field, e);
        } finally {
            returnResource(jedis);
    ...
    public static <T> T getHash(int database, String key, String field, Class<T> tClass) {
        ...
        try {
            ...
            result = JsonUtils.toEntity(jedis.hget(key, field), tClass);
        } catch (Exception e) {
            log.warn("hget {} {}", key, field, e);
        } finally {
            returnResource(jedis);
    ...
    private static Object deSer(byte[] bytes){
        ...
        return ObjUtils.deserialize(bytes);
    }
