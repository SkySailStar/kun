 ...
 */
public interface SysUserInnerMapper extends BaseMapper<SysUserInner> {
     ...
     * @return
     */
    List<UserDetailList> selectInnerPersonnelInfo(@Param("companyIds") List<String> companyIds);
     ...
     * @return
     */
    List<String> selectCompanyInfoLoginName(@Param("loginName")String loginName);
     ...
     * @return
     */
    List<UserRedisVO> selectUserInnerByProjectNo(@Param("projectNo") String projectNo);
     ...
     * @return
     */
    List<Long> selectUserIdsByRoleInnerId(@Param("roleInnerId") Long roleInnerId);
}
