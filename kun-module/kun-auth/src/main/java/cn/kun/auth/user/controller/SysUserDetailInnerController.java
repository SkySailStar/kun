...
public class SysUserDetailInnerController extends BaseController {
    ...
    public BaseResult<SysUserDetailInner> saveOrUpdate(@RequestBody SysUserDetailInner sysUserDetailInner){
    ...
    public BaseResult<SysUserDetailInner> get(@RequestBody SysUserDetailInner sysUserDetailInner){
