package cn.kun.auth.system.role.mapper;
 ...
 */
public interface SysRoleOuterMapper extends BaseMapper<SysRoleOuter> {
     ...
     * @return
     */
    List<RoleInfoByUserIdVO> getRoleInfoByUserId(@Param("userId") Long userId);

    List<RoleInfoByUserIdVO> getRoleOuterByRoleOuterId(@Param("userOuterId") Long userOuterId);
     ...
     * @return
     */
    List<UserDetailList> selectOuterPersonnelInfoRoleId(@Param("roleId")Long roleId, @Param("companyIds")List<String> companyIds);
