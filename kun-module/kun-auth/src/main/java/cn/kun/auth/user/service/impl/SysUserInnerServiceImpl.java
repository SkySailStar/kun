...
import cn.kun.auth.user.entity.po.SysUserDetailInner;
import cn.kun.auth.user.entity.po.SysUserInner;
import cn.kun.auth.user.entity.po.SysUserJobInner;
import cn.kun.auth.user.entity.po.SysUserMenuInner;
...
import cn.kun.auth.user.entity.vo.UserDetailListVO;
import cn.kun.auth.user.entity.vo.UserJobInfoVO;
...
import cn.kun.auth.user.mapper.SysUserInnerMapper;
import cn.kun.auth.user.service.SysUserMenuInnerService;
import cn.kun.auth.user.service.SysUserOuterService;
import cn.kun.auth.user.service.SysUserRoleInnerService;
...
import cn.kun.auth.user.service.SysUserDetailInnerService;
